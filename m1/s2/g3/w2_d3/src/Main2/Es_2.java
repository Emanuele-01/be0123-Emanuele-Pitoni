...
public class Es_2 implements Runnable {
	...
	public Es_2(int[] arrayElementi, int indiceIniziale, int numeroElementi, List<Integer> listaRisultati) {
		super();
	...
	public static void main(String[] args) {
		...
		List<Runnable> listaRunnable = Arrays.asList(new Es_2(elementiDaSommare, 0, 1000, listaRisultati),
				new Es_2(elementiDaSommare, 1000, 1000, listaRisultati),
				new Es_2(elementiDaSommare, 2000, 1000, listaRisultati));
